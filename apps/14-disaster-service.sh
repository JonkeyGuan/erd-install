...
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-sa.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-role-binding-sa-view.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-binary-buildconfig.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-imagestream.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-imagestream.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-role-binding-jenkins-edit.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/disaster-service-pipeline.yaml" | oc -n ${namespace_tools} apply -f -

eval "${token_cmd} ${my_dir}/${resource}/disaster-service.yaml" | oc -n ${namespace} apply -f -
