...
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-sa.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-role-binding-sa-view.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-binary-buildconfig.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-imagestream.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-imagestream.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-role-binding-jenkins-edit.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/process-viewer-pipeline.yaml" | oc -n ${namespace_tools} apply -f -

eval "${token_cmd} ${my_dir}/${resource}/process-viewer.yaml" | oc -n ${namespace} apply -f -
