...
resource="responder-simulator-service"
...
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-sa.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-role-binding-sa-view.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-binary-buildconfig.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-imagestream.yaml" | oc -n ${namespace_tools} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-imagestream.yaml" | oc -n ${namespace} apply -f -
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-role-binding-jenkins-edit.yaml" | oc -n ${namespace} apply -f -
...
eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service-pipeline.yaml" | oc -n ${namespace_tools} apply -f -

eval "${token_cmd} ${my_dir}/${resource}/responder-simulator-service.yaml" | oc -n ${namespace} apply -f -
